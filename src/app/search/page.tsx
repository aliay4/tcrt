...
function SearchContent() {
  ...
  const performSearch = async (searchTerm: string) => {
    ...
    try {
      const result = await productApi.getAll({ search: searchTerm });
          ...
          {query && (
            <div className="flex items-center justify-between">
              <p className="text-gray-600">
                <span className="font-semibold">"{query}"</span> için <span className="font-semibold">{products.length}</span> sonuç bulundu
              </p>
              <button
          ...
          <div className="flex-1">
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Arama Hatası</h3>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">
                  {query ? `"${query}" için arama sonucu bulunamadı.` : 'Arama yapmak için yukarıdaki kutuyu kullanın.'}
                </p>
              </div>
            ) : (
              <>
