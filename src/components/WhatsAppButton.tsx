...
export default function WhatsAppButton({ 
  ...
  useEffect(() => {
    // Sayfa yüklendikten 2 saniye sonra butonu göster
  ...
  return (
    <div className={`fixed ${getPositionClasses()} z-50`}>
      {/* Tooltip */}
      <div className={`absolute bottom-full mb-3 right-0 bg-gray-900 text-white px-4 py-2 rounded-lg shadow-lg text-sm whitespace-nowrap transition-all duration-300 ${
